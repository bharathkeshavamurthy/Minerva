...
\begin{figure}
    ...
    \bk{I call the Markov Chain across the channel indices (frequency) as a Spatial Markov Chain to contrast between the Markov Chain across the time indices (rounds) which I refer to as the Temporal Markov Chain. Do you have another name in mind?}}
    \label{fig:1}
\end{figure}
...
\bk{Yes, I talk about OFDMA slightly later in this paragraph. Please refer to "We further assume that the P PUs employ..." Do you want me to move it before equation \eqref{2}?}
...
\bk{Change $A$ to $\mathbf{P}$ and change $M$ to $\mathbf{M}$ here to be consistent with the notation in the earlier sections...}
