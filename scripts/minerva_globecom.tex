...
\nm{I mean, you are hastily presenting your modifications of PERSEUS but you should describe them in more details.. anyway,  believe that this is a lower priority thing, given the space constraint, so fix all the rest first and then we can decide about this one.}
\section{Numerical Evaluation}\label{IV}
\nm{I thought you were working on the state of the art comparison, where is that?}
\begin{figure}
    \centering
...
\nm{you need to cut down the reference list to 15-16 max}
